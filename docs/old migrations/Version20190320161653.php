 ...
 */
final class Version20190320161653 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE wedding_event (wedding_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_3BE7D67371F7E88B (event_id), INDEX IDX_3BE7D673FCBBB0ED (wedding_id), PRIMARY KEY(wedding_id, event_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
