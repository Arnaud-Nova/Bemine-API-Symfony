 ...
 */
final class Version20190401094829 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, wedding_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, url_avatar VARCHAR(255) DEFAULT NULL, api_token VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D6497BA2F5EB (api_token), UNIQUE INDEX UNIQ_8D93D649FCBBB0ED (wedding_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, wedding_id INT DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, postcode INT DEFAULT NULL, city VARCHAR(80) DEFAULT NULL, schedule DATETIME DEFAULT NULL, informations LONGTEXT DEFAULT NULL, active TINYINT(1) DEFAULT NULL, map LONGTEXT DEFAULT NULL, name VARCHAR(50) DEFAULT NULL, hour VARCHAR(30) DEFAULT NULL, INDEX IDX_3BAE0AA7FCBBB0ED (wedding_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
