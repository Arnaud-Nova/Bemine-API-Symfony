 ...
 */
final class Version20190321151837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE person CHANGE allergies allergies TINYINT(1) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE person CHANGE allergies allergies TINYINT(1) NOT NULL');
    }
}
