...
/**
 * @ORM\Entity(repositoryClass="App\Repository\WeddingEventRepository")
 */
class WeddingEvent
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Wedding", inversedBy="weddingEvents")
     */
    private $wedding;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Event", inversedBy="weddingEvents")
     */
    private $event;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\GuestGroup", mappedBy="weddingEvent")
     */
    private $guestGroups;
    ...
    public function addGuestGroup(GuestGroup $guestGroup): self
    {
        if (!$this->guestGroups->contains($guestGroup)) {
            ...
            $guestGroup->addWeddingEvent($this);
        }
    ...
    public function removeGuestGroup(GuestGroup $guestGroup): self
    {
        if ($this->guestGroups->contains($guestGroup)) {
            ...
            $guestGroup->removeWeddingEvent($this);
        }
